...
enum class ToolbarTool(
    ...
    CLIPBOARD("clipboard", com.example.R.string.tool_clipboard, com.example.R.drawable.sym_keyboard_clipboard_rounded, true, true),
    TEXT_EDIT("text_edit", com.example.R.string.tool_text_edit, com.example.R.drawable.ic_dpad_rounded, true, false),
    ...
    INCOGNITO("incognito", com.example.R.string.tool_incognito, com.example.R.drawable.sym_keyboard_incognito_lxx, true, false),
    ...
    UNDO("undo", com.example.R.string.tool_undo, com.example.R.drawable.ic_undo_rounded, true, false),
    REDO("redo", com.example.R.string.tool_redo, com.example.R.drawable.ic_redo_rounded, true, false),
    SELECT_WORD("select_word", com.example.R.string.tool_select_word, com.example.R.drawable.ic_select_word, true, false),
    SELECT_ALL("select_all", com.example.R.string.tool_select_all, com.example.R.drawable.ic_select_all_rounded, false, true),
    COPY("copy", com.example.R.string.tool_copy, com.example.R.drawable.sym_keyboard_copy_rounded, true, true),
    PASTE("paste", com.example.R.string.tool_paste, com.example.R.drawable.ic_paste, true, false),
    ...
    VOICE("voice", com.example.R.string.tool_voice, com.example.R.drawable.sym_keyboard_voice_rounded, true, false),
